...
export const PARTICLE_QUANTUM_DATA: readonly ParticleQuantumData[] = [
    ...
    { properties: { symbol: 'd', name: 'anti down', family: 'Quark', matterType: ParticleMatterType.ANTIMATTER, charge: 1 / 3, magneticFieldStrength: 0.5, massInMeV: 4.7 }, render: { coreDiameter: TOKENS.sizes.CIRCLE_MINI_6, coreColor: 'var(--particle-quark-antimatter)' }, physics: { interactionRange: 10, collisionRadius: 2, mass: 9.4 }, table: { shortForm: { x: 4, y: 1 } } },
    ...
    { properties: { symbol: 's', name: 'anti strange', family: 'Quark', matterType: ParticleMatterType.ANTIMATTER, charge: 1 / 3, magneticFieldStrength: 0.5, massInMeV: 96 }, render: { coreDiameter: TOKENS.sizes.CIRCLE_MINI_6, coreColor: 'var(--particle-quark-antimatter)' }, physics: { interactionRange: 10, collisionRadius: 2, mass: 190 }, table: { shortForm: { x: 5, y: 1 } } },
    ...
    { properties: { symbol: 'b', name: 'anti bottom', family: 'Quark', matterType: ParticleMatterType.ANTIMATTER, charge: 1 / 3, magneticFieldStrength: 0.5, massInMeV: 4180 }, render: { coreDiameter: TOKENS.sizes.CIRCLE_MINI_6, coreColor: 'var(--particle-quark-antimatter)' }, physics: { interactionRange: 10, collisionRadius: 2, mass: 9200 }, table: { shortForm: { x: 6, y: 1 } } },
    // Leptons 
