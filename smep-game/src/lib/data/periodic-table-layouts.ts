...
// This file is no longer needed , the new file is .ts
// TODO: remove this file after all the code is migrated to the new file

import { PARTICLE_ATOMIC_DATA } from './particle-atomic.data.ts 22-38-27-025';
...
// All atomic elements from data (single source of truth)
export const ALL_ATOMIC_ELEMENTS: AtomicElement[] = PARTICLE_ATOMIC_DATA as AtomicElement[];
