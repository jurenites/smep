...
export const TOKENS = {
    ...
    sizes: {
        ...
        // Animation durations
        ANIMATION_IMMEDIATE: 0,
        ANIMATION_FAST: 0.1,
        ANIMATION_SLOW: 0.3,
        SKELETON_WAVE_DURATION: 1.5,
...
export const CSS_VARS = {
    ...
    // Animation durations
    '--animation-immediate': `${TOKENS.sizes.ANIMATION_IMMEDIATE}s`,
    '--animation-fast': `${TOKENS.sizes.ANIMATION_FAST}s`,
    '--animation-slow': `${TOKENS.sizes.ANIMATION_SLOW}s`,
    '--skeleton-wave-duration': `${TOKENS.sizes.SKELETON_WAVE_DURATION}s`,
