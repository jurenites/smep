...
export const PARTICLE_QUANTUM_DATA: readonly ParticleQuantumData[] = [
    // Quarks - QCD color charge is now controlled dynamically via UIParticle qcdColor prop
    ...
    // Antiquarks - same as quarks but opposite charges (QCD colors controlled dynamically)
